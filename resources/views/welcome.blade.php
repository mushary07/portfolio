...
<body class="bg-fixed home-vcard" style="background-image: url('{{ asset('assets/img/shape/banner.jpg') }}');">
            ...
            <div class="nav-wrapper">
                <div class="side-navbar">
                    <div class="side-nav-menu">
                        <a class="smooth-menu" href="#home"><img src="{{ asset('assets/img/logo-icon.png') }}"
                                alt="Logo"></a>
                    </div>
                    <div class="nav-toggle">
                        <img src="{{ asset('assets/img/menu-white.svg') }}" alt="Menu">
                    </div>
                    {{-- <div class="author-social">
                        ...
                        <a href="https://www.facebook.com/mushary07/" target="blank" class="share-icon facebook">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a href="https://www.instagram.com/mushary07/" target="blank" class="share-icon instagram">
        ...
        <div class="main-content-area">
            ...
            <div class="section-item animated" id="home">
                <div class="banner-style-two-area default-padding">
                    ...
                    <div class="personal-social">
                        <ul>
                            <li class="linkedin">
                                <a href="https://www.linkedin.com/in/mushary07/" target="blank">
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                            </li>
                            <li class="instagram">
                                <a href="https://www.instagram.com/mushary07/" target="blank">
                                    <i class="fab fa-instagram"></i>
                                </a>
                            </li>
                            <li class="facebook">
                                <a href="https://www.facebook.com/mushary07/" target="blank">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                            </li>
                        </ul>
                    ...
                    {{-- <div class="author-thumb"
                        style="background-image: url('{{ asset('assets/img/illustration/5.png') }}');">
                    </div> --}}
                            ...
                            <div class="row">
                                <div class="col-lg-12 pr-50">
                                    <div class="information">
                                        <div class="content">
                                            <h2>Hey <img src="{{ asset('assets/img/shape/harnd.png') }}"
                                                    alt="image not found"> , I'm Mushary
                                            </h2>
                                            <h3 class="title">
                                                <span class="header-caption" id="page-top">
                                                    ...
                                                    <span class="cd-headline clip is-full-width">
                                                        ...
                                                        <span class="cd-words-wrapper">
                                                            <b class="is-visible">Laravel & Vue.js Specialist</b>
                                                            <b class="is-hidden">Full-Stack PHP & MySQL Developer</b>
                                                            <b class="is-hidden">Expert in Livewire & Inertia.js</b>
                                                            <b class="is-hidden">Tailwind CSS & Vuetify UI Designer</b>
                                                            <b class="is-hidden">Clean Code & Scalable Architecture</b>
                                                        </span>
                                                    </span>
                                                    <!-- type headline end -->
                                                </span>
                            ...
                            <div class="col-lg-12">
                                <div class="expertise-items">
                                    ...
                                    <div class="expterise-item">
                                        <div class="top">
                                            <div class="icon">
                                                <img src="{{ asset('assets/img/icon/figma.png') }}"
                                                    alt="Image Not Found">
                                            </div>
                                            <div class="fun-fact">
                                                <div class="counter">
                                    ...
                                    <div class="expterise-item">
                                        <div class="top">
                                            <div class="icon">
                                                <img src="{{ asset('assets/img/icon/wordpress.png') }}"
                                                    alt="Image Not Found">
                                            </div>
                                            <div class="fun-fact">
                                                <div class="counter">
                                    ...
                                    <div class="expterise-item">
                                        <div class="top">
                                            <div class="icon">
                                                <img src="{{ asset('assets/img/icon/react.png') }}"
                                                    alt="Image Not Found">
                                            </div>
                                            <div class="fun-fact">
                                                <div class="counter">
                                    ...
                                    <div class="expterise-item">
                                        <div class="top">
                                            <div class="icon">
                                                <img src="{{ asset('assets/img/icon/python.png') }}"
                                                    alt="Image Not Found">
                                            </div>
                                            <div class="fun-fact">
                                                <div class="counter">
                                    ...
                                    <div class="expterise-item">
                                        <div class="top">
                                            <div class="icon">
                                                <img src="{{ asset('assets/img/icon/ruby.png') }}"
                                                    alt="Image Not Found">
                                            </div>
                                            <div class="fun-fact">
                                                <div class="counter">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-7 pl-50 pl-md-15 pl-xs-15">
                                                                <div class="services-two-info">
                                                                    ...
                                                                    <p>
                                                                        Bndulgence diminution so discovered mr
                                                                        apartments. Are off under folly death wrote
                                                                        cause her way spite. Plan upon yet way get cold
                                                                        spot its week. Almost do am or limits hearts.
                                                                        Resolve parties but why she shewing. She sang
                                                                        know now
                                                                    </p>
                                                                    ...
                                                                    <a href="#contact"
                                                                        class="btn btn-md circle btn-theme effect smooth-menu">Hire
                                                                        Now</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-7 pl-50 pl-md-15 pl-xs-15">
                                                                <div class="services-two-info">
                                                                    ...
                                                                    <p>
                                                                        Technical diminution so discovered mr
                                                                        apartments. Are off under folly death wrote
                                                                        cause her way spite. Plan upon yet way get cold
                                                                        spot its week. Almost do am or limits hearts.
                                                                        Resolve parties but why she shewing. She sang
                            ...
                            <div class="col-lg-12 col-xl-7 offset-xl-1">
                                <div class="pricing-style-one-items">
                                    ...
                                    <div class="nav nav-tabs pricing-tab-navs" id="nav-tab" role="tablist">
                                        <button class="nav-link active" id="nav-id-1" data-bs-toggle="tab"
                                            data-bs-target="#tab1" type="button" role="tab"
                                            aria-controls="tab1" aria-selected="true">
                                            <span>Monthly</span>
                                        </button>
                                        <button class="nav-link" id="nav-id-2" data-bs-toggle="tab"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="pricing-style-one active">
                                                        ...
                                                        <a class="btn mt-25 btn-sm circle btn-dark"
                                                            href="#contact">Order Now</a>
                                                    </div>
                                                </div>
                                                <!-- End Single Item -->
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="about-style-two-thumb text-center">
                                    <img src="{{ asset('assets/img/800x800.png') }}" alt="Image Not Found">
                                    <div class="info">
                                        <h3>James Baker</h3>
                            ...
                            <div class="col-lg-6 offset-lg-1 mt-50">
                                <div class="about-style-one-info">
                                    ...
                                    <p>
                                        I'm creative designer based in USA, and I'm very passionate and dedicated to my
                                        work. Since all Weblium templates are developed on the basis of a deep study of
                                        the niche and harmoniously combine the most current trends in web design,
                                        sometimes it’s enough to simply choose a template, add your own unique content
                                        and get a beautiful website with the perfect navigation for your type of busin.
                                    </p>
                                    <!-- Single Item -->
                                    ...
                                    <div class="pf-item-info">
                                        <div class="content-info">
                                            ...
                                            <h2><a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#projectSingleModal">Photo shooting and editing</a>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="portfolio-style-one">
                                    ...
                                    <div class="pf-item-info">
                                        <div class="content-info">
                                            <span>Creative</span>
                                            <h2><a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#projectSingleModal">Quality in industrial
                                                    design</a></h2>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="portfolio-style-one">
                                    ...
                                    <div class="pf-item-info">
                                        <div class="content-info">
                                            <span>Design</span>
                                            <h2><a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#projectSingleModal">Blue business mockup cards</a>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="portfolio-style-one">
                                    ...
                                    <div class="pf-item-info">
                                        <div class="content-info">
                                            <span>Business</span>
                                            <h2><a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#projectSingleModal">Simple black & white design
                                                </a></h2>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-style-one">
                                                    ...
                                                    <div class="item">
                                                        <div class="thumb">
                                                            <img src="{{ asset('assets/img/800x800.png') }}"
                                                                alt="Image Not Found">
                                                        </div>
                                                        <div class="content">
                                                            <p>
                                                                “Targetingconsultation discover apartments. ndulgence
                                                                ...
                                                                sang know now always remembering to the point.”
                                                            </p>
                                                        </div>
                                                        <div class="provider">
                                                            <div class="rating">
                        ...
                        <div class="row">
                                ...
                                <div class="item">
                                    <div class="thumb">
                                        <a href="blog-single-with-sidebar.html"><img
                                                src="{{ asset('assets/img/800x600.png') }}" alt="Thumb"></a>
                                    ...
                                    <div class="info">
                                        <h4>
                                            <a href="blog-single-with-sidebar.html">Miscovery incommode earnestly
                                                commanded if.</a>
                                        </h4>
                                        <div class="meta">
                                            <ul>
                            ...
                            <div class="blog-style-one mb-30 col-xl-4 col-md-6">
                                <div class="item">
                                    ...
                                    <div class="info">
                                        <h4>
                                            <a href="blog-single-with-sidebar.html">Bethering occurs concerns removing
                                                desirous.</a>
                                        </h4>
                                        <div class="meta">
                                            <ul>
            ...
            <div class="section-item" id="contact">
                <div class="contact-area contact-page overflow-hidden default-padding"
                    style="background-image: url('{{ asset('assets/img/shape/map.png') }}');">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-tact-stye-one col-lg-5 pr-50 pr-md-15 pr-xs-15">
                                <div class="contact-style-one-info">
                                    <div class="top-info">
                                        ...
                                        <div class="call">
                                            <img src="{{ asset('assets/img/icon/call.png') }}" alt="Image not Found">
                                    ...
                                    <ul class="contact-address">
                                        <li>
                                            <div class="info">
                                                <h4>Location</h4>
                                                <p>
                                                    No:67, Paris Nagar, <br> Vayalkarai Street, <br> 1st Cross Street,
                                                    Karaikal
                                                </p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="info">
                                                ...
                                                <a href="mailto:mushari1999@gmail.com">mushari1999@gmail.com</a>
                                            </div>
                                        </li>
                                    </ul>
                                    <p class="copyright">
                                        &copy; {{ date('Y') }} Mushary – Laravel & Vue Developer. All rights
                                        reserved.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-tact-stye-one col-lg-7 pl-60 pl-md-15 pl-xs-15 mt-md-50 mt-xs-50">
                                <div class="contact-form-style-one">
                                    <form action="{{ asset('assets/mail/contact.php') }}" method="POST"
                                                ...
                                                <div class="project-details mt-60 mt-xs-30">
                                                    <div class="top-info">
                                                        <div class="row">
                                                            ...
                                                            <div
                                                                class="col-lg-5 pl-50 pl-md-15 pl-xs-15 order-lg-last">
                                                            ...
                                                            <div class="col-lg-7">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    malesuada nulla habitasse hymenaeos. Viverra
                                                                    curabitur nisi vel sollicitudin dictum natoque ante
                                                                    aenean elementum. Vulgar as hearts by garret.
                                                                    Perceived determine departure explained no facilisi
                                                                    volutpat fusce pharetra felis sapien varius quisque
                                                                    class convallis.
                                                                </p>
                                                            </div>
                                                    ...
                                                    <div class="row mt-40 mb-40">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="thumb-grid">
                                                                <img src="{{ asset('assets/img/600x800.png') }}"
                                                                    alt="Thumb">
                                                                <img src="{{ asset('assets/img/600x800.png') }}"
                                                                    alt="Thumb">
                                                            </div>
                                                    ...
                                                    <p>
                                                        ...
                                                        direction neglected but supported yet her. Facilisis inceptos
                                                        nec, potenti nostra aenean lacinia varius semper ant nullam
                                                        nulla primis placerat facilisis. Netus lorem rutrum arcu
                                                        dignissim at sit morbi phasellus nascetur eget urna potenti cum
                                                        vestibulum cras. Tempor nonummy metus lobortis. Sociis velit
                                                        etiam, dapibus. Lectus vehicula pellentesque cras posuere tempor
                                                        facilisi habitant lectus rutrum pede quisque hendrerit
                                                        parturient posuere mauris ad elementum fringilla facilisi
                                                        volutpat fusce pharetra felis sapien varius quisque class
                                                        convallis praesent est sollicitudin donec nulla venenatis,
                                                        cursus fermentum netus posuere sociis porta risus habitant
                                                        malesuada nulla habitasse hymenaeos. Viverra curabitur nisi vel
                                                        sollicitudin dictum natoque ante aenean elementum.
                                                    </p>
                                                    <div class="row mt-50 mt-xs-30">
                                                        <div class="col-lg-6 col-md-6">
                                                            <img src="{{ asset('assets/img/800x600.png') }}"
                                                                alt="Thumb">
                                                        </div>
