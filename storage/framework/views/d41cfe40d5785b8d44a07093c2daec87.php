                ...
                <div class="credential-sidebar-wrap" data-aos="zoom-in">
                    <div class="credential-sidebar text-center">
                        <div class="shadow-box">
                            ...
                            <a href="<?php echo e(route('contact')); ?>" class="theme-btn">Contact Me</a>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laravel\Portfolio\resources\views/credential.blade.php ENDPATH**/ ?>